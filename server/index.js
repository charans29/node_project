...
app.get('/files', async (req, res) => {
  // Assuming you have a way to get or refresh the token
  ...
  drive.files.list({
    q: "mimeType='application/pdf'", // Query for PDF files only
    pageSize: 10, // You can adjust this as needed
    fields: 'files(id, name)', // Specify the fields you want to get
  }, (err, response) => {
    if (err) {
